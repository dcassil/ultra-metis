...
1. **workspace_init**  
Command: `target/release/cadre init --path /var/folders/89/m2y2jh5s5278yknk94vztqs40000gn/T/.tmpbN3lWp --prefix BENCH`  
Exit code: `0`  
Duration: 0.01s  
Approx tokens: 28
Stdout excerpt:
```text
Initialized Cadre project at /var/folders/89/m2y2jh5s5278yknk94vztqs40000gn/T/.tmpbN3lWp with prefix BENCH
```

2. **seed_vision**  
Command: `target/release/cadre create --type vision --path /var/folders/89/m2y2jh5s5278yknk94vztqs40000gn/T/.tmpbN3lWp File Processing Toolkit`  
Exit code: `0`  
Duration: 0.01s  
Approx tokens: 13
Stdout excerpt:
...
Command: `target/release/cadre create --type initiative --path /var/folders/89/m2y2jh5s5278yknk94vztqs40000gn/T/.tmpbN3lWp --parent BENCH-V-0001 Parse Module`  
Exit code: `0`  
Duration: 0.02s  
Approx tokens: 12
Stdout excerpt:
...
Command: `target/release/cadre create --type initiative --path /var/folders/89/m2y2jh5s5278yknk94vztqs40000gn/T/.tmpbN3lWp --parent BENCH-V-0001 Transform Module`  
Exit code: `0`  
Duration: 0.01s  
Approx tokens: 13
Stdout excerpt:
...
Command: `target/release/cadre create --type initiative --path /var/folders/89/m2y2jh5s5278yknk94vztqs40000gn/T/.tmpbN3lWp --parent BENCH-V-0001 Output Module`  
Exit code: `0`  
Duration: 0.03s  
Approx tokens: 12
Stdout excerpt:
