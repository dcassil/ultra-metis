---
description: "Decompose an Ultra-Metis epic into typed stories"
argument-hint: "SHORT_CODE [--max-iterations N]"
allowed-tools: ["Bash(${CLAUDE_PLUGIN_ROOT}/scripts/setup-ultra-metis-decompose.sh:*)", "mcp__ultra-metis__read_document"]
hide-from-slash-command-tool: "true"
---

# Ultra-Metis Decompose - Epic to Stories
...
```bash
"${CLAUDE_PLUGIN_ROOT}/scripts/setup-ultra-metis-decompose.sh" $ARGUMENTS
```
...
- Log progress to the epic document using `mcp__ultra-metis__edit_document`
