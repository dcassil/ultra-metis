---
description: "Execute an Ultra-Metis story or task with Ralph loop"
argument-hint: "SHORT_CODE [--max-iterations N]"
allowed-tools: ["Bash(${CLAUDE_PLUGIN_ROOT}/scripts/setup-ultra-metis-ralph.sh:*)", "mcp__ultra-metis__read_document"]
hide-from-slash-command-tool: "true"
---

# Ultra-Metis Ralph - Story/Task Execution
...
Use `mcp__ultra-metis__read_document` to verify:
...
```bash
"${CLAUDE_PLUGIN_ROOT}/scripts/setup-ultra-metis-ralph.sh" $ARGUMENTS
```
...
- Use `mcp__ultra-metis__edit_document` to log progress after each significant step
