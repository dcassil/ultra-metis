...
When decomposing an epic, use Ultra-Metis tools:
...
**CRITICAL**: After creating each story, immediately populate it with real content using `mcp__ultra-metis__edit_document`. A story with template placeholders is incomplete and useless. Each story needs:
