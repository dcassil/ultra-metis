...
description: "This skill should be used when the user asks to 'start a new project', 'greenfield project', 'tech debt campaign', 'incident response', 'feature development', 'initialize ultra-metis', 'set up project', or needs guidance on project setup and applying patterns for different work types."
---
...
## Ultra-Metis Planning Hierarchy
...
```
mcp__ultra-metis__create_document(type="epic", title="API Cleanup Campaign", parent_id="PROJ-PD-0001")
```

**2. Create Stories by debt type:**
```
mcp__ultra-metis__create_document(type="story", title="Refactor auth middleware", parent_id="PROJ-E-0001", story_type="refactor")
```
...
```
mcp__ultra-metis__create_document(type="story", title="INCIDENT: Service X down", parent_id="PROJ-E-0001", story_type="bugfix")
```
...
```
mcp__ultra-metis__create_document(type="epic", title="Prevent X recurrence", parent_id="PROJ-PD-0001")
```
...
```
mcp__ultra-metis__create_document(type="epic", title="User Dashboard", parent_id="PROJ-PD-0001", complexity="m")
```
...
|--------------|---------|-----|
| **Shadow work** | Work outside system | Track everything in Ultra-Metis |
