---
name: cadre:help
description: "Explain Cadre plugin and available commands. Use when user asks about cadre, how it works, what tools are available, or needs an overview of the system."
---

# Cadre Help

Cadre is a repo-native AI engineering orchestration system. It manages work through a hierarchical document model that flows through lifecycle phases.
...
All tools use the `mcp__cadre__` prefix:

| Tool | Purpose |
|------|---------|
| `initialize_project` | Create a new Cadre workspace |
