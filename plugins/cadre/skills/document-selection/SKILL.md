...
This skill helps choose the right Cadre document type for different kinds of work.
...
When users request work items using common terms, map to Cadre document types:
