...
pub struct InsightScope {
    /// Repository name (e.g., "ultra-metis").
...
mod tests {
    ...
    fn make_scope() -> InsightScope {
        InsightScope {
            repo: Some("ultra-metis".to_string()),
            package: Some("ultra-metis-core".to_string()),
    ...
    fn test_scope_matching() {
        ...
        query.repo = Some("ultra-metis".to_string());
        assert!(scope.matches(&query));

        // Match by package
        let mut query = InsightScope::new();
        query.package = Some("ultra-metis-core".to_string());
        assert!(scope.matches(&query));
