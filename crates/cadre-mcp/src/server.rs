use crate::tools::{
    AnalyzeProjectTool, ArchiveDocumentTool, CadreTools, CaptureQualityBaselineTool,
    CheckArchitectureConformanceTool, CompareQualityBaselinesTool, CreateCrossReferenceTool,
    CreateDocumentTool, CreateInsightNoteTool, EditDocumentTool, EvaluateBrownfieldTool,
    FetchInsightNotesTool, GetApplicableRulesTool, IndexCodeTool, InitializeProjectTool,
    ListCatalogLanguagesTool, ListCrossReferencesTool, ListDocumentsTool, ListInsightNotesTool,
    ListProtectedRulesTool, ListQualityRecordsTool, QueryArchitectureCatalogTool,
    QueryRelationshipsTool, QueryRulesTool, ReadReferenceArchitectureTool, ReassignParentTool,
    ReadDocumentTool, ScoreInsightNoteTool, SearchDocumentsTool, TraceAncestryTool,
    TransitionPhaseTool,
};
use crate::log;
...
impl ServerHandler for CadreServerHandler {
    ...
    async fn handle_call_tool_request(
        ...
        let result = match params.name.as_str() {
            "analyze_project" => {
                let tool: AnalyzeProjectTool = serde_json::from_value(args)
