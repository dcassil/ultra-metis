...
- **initialize_project** — Initialize a new .ultra-metis directory.
...
pub const PROMPT_NAME: &str = "ultra-metis-guide";

/// The prompt description.
pub const PROMPT_DESCRIPTION: &str =
    "Complete tool reference, domain concepts, and workflow recipes for Ultra-Metis";
