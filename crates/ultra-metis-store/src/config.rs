//! Project configuration stored in `.ultra-metis/config.toml`
...
const PROJECT_DIR: &str = ".ultra-metis";
...
impl ProjectConfig {
    ...
    /// Get the `.ultra-metis/` directory path for a project root
...
/// The directory name used for ultra-metis projects
...
mod tests {
    ...
    fn test_config_roundtrip() {
        ...
        // Create the .ultra-metis directory
